...
<head>
    <meta charset="utf-8">
    <title>Faculty Of Information & Communication Technology</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Programs Of Faculty Of Information & Communication Technology</h1>
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/ICT/graphic.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">PRACTICAL DIPLOMA IN GRAPHIC DESIGN</h4>
                                    <a class="text-uppercase" href="{{url('graphic')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/ICT/englishC.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">EXECUTIVE CERTIFICATE IN ENGLISH & IT</h4>
                                    <a class="text-uppercase" href="{{url('certificate')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/ICT/englishD.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">DIPLOMA IN ENGLISH & IT</h4>
                                    <a class="text-uppercase" href="{{url('diploma')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/ICT/digital.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">EXECUTIVE CERTIFICATE IN DIGITAL MARKETING</h4>
                                    <a class="text-uppercase" href="{{url('digital')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/ICT/excel.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">ADVANCED EXCEL SKILLS FOR PROFESSIONALS: MASTERING ADVANCED FUNCTIONS FOR PROFESSIONAL GROWTH</h4>
                                    <a class="text-uppercase" href="{{url('advanced')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
