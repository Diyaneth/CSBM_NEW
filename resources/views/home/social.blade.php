        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Programs Of Social Sciences</h1>
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/social/sports.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">HIGHER DIPLOMA IN SPORTS AND EXERCISE SCIENCE</h4>
                                    <a class="text-uppercase" href="{{url('sports')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/social/mental.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">PRACTICAL DIPLOMA IN MENTAL HEALTH</h4>
                                    <a class="text-uppercase" href="{{url('mental')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/social/drugs.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">ADVANCED CERTIFICATE IN DRUGS LAW ENFORCEMENT</h4>
                                    <a class="text-uppercase" href="{{url('drugs')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/social/care.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">CERTIFICATE IN CARE GIVER</h4>
                                    <a class="text-uppercase" href="{{url('care')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="home/img/social/pedagogy.png" alt="">
                                </div>
                                <div class="p-4">
                                    <h4 class="mb-3">PEDAGOGY IN EARLY CHILDHOOD AND PRIMARY EDUCATION</h4>
                                    <a class="text-uppercase" href="{{url('pedagogy')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div> 
                    </div>
